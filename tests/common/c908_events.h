...
struct event_counter events_counter_list[] = {
  ...
  {ALU_INSTR, "ALU_INSTR", 0, 0},
  {ISSUE_INSTR, "ISSUE_INSTR", 0, 0},
  //{CSR_INSTR, "CSR_INSTR", 0, 0},
  {LOAD_INSTR, "LOAD_INSTR", 0, 0},
  {FUSED_INSTR, "FUSED_INSTR", 0, 0},
  {MULT_INSTR, "MULT_INSTR", 0, 0},
  {DIV_INSTR, "DIV_INSTR", 0, 0},
  {BRANCH_INSTR, "BRANCH_INSTR", 0, 0},
  ...
  {INSTR_TOTAL, "INSTR_TOTAL", 40, 0},
  {CYCLES_TOTAL, "CYCLES_TOTAL", 26, 0},
